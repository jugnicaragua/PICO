...
import org.jugni.apps.pico.ui.catalogue.CuentaForm;
...
public class MenuPrincipalAcciones {
  ...
  public static void mostrarVentanaDatosEmpresa() {
    //TODO: DESPUES mostrarVentana(EmpresaView.getInstancia());
  }

  // Muestra la ventana de formulario catalogo de tipo de cuenta
  public static void mostrarVentanaCuentaTipo() {
    //TODO: DESPUES mostrarVentana(CuentaTipoForm.getInstancia());
  }
  ...
  public static void mostrarNuevoVentanaCuenta() {
    //TODO: DESPUES mostrarVentana(CuentaForm.getInstancia());
  }
  ...
  private static void mostrarVentana(JInternalFrame frm) {
    try {
      ...
      if (!frm.isVisible()) {
        //TODO: DESPUES MainView.agregarAlEscritorio(frm);
      } else {
        // si la ventana esta visible pero debajo de otras ventanas se mueve al frente y se
        // selecciona
        frm.moveToFront();
        if (!frm.isSelected()) {
