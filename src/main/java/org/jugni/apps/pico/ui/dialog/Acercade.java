...
public class Acercade extends JDialogoUtil {
  ...
  /*
   * public static void main(String[] args) { try { Acercade dialog = new Acercade();
  ...
  private void initAcercade() {
    ...
    // Se inicisilizan los componentes
    {
      ...
      // Cuando se preciona un hyperlink llama a la palicacion predeterminanda en el sistema
      // operativo
      ...
      txtPanel.setText("<STROM><B>PICO </B><STROM>" + "-Sistema de contable" + "<BR>"
          + "<B>Version    :</B>" + "2019-05" + "<BR>" + "<B>Licencia   :</B>" + "GPLv3" + "<BR>"
          + "<BR>" + "<B>Usuario    :</B>" + System.getProperty("user.name") + "<BR>"
          + "<B>Directorio :</B>" + System.getProperty("user.home") + "<BR>"
          + "<B>SO            :</B>" + System.getProperty("os.name") + "-"
          + System.getProperty("os.arch") + "<BR>" + "<B>Java          :</B>"
          + System.getProperty("java.vendor") + "-" + System.getProperty("java.version") + "<BR>"
          + "<B>From:</B> " + System.getProperty("java.home") + " <a href=\" "
          + System.getProperty("java.vendor.url") + "\" >" + System.getProperty("java.vendor.url")
          + "</a> <BR><BR>" + "Grupo de Usuarios Java de Nicaragua." + "<BR>" + "<BR>"
          + " ====== Autores y Colaboradores ====== <BR>" + "Gustavo Castro "
          + "<a href=\"mailto:gacsnic75@gmail.com\"> gacsnic75@gmail.com  </a> " + "<BR>"
          + "perencejo " + "<a href=\"mailto:ffff@gmail.com\"> perencejo  </a> " + "<BR>"
          + "perencejo " + "<a href=\"mailto:ffff@gmail.com\"> perencejo  </a> " + "<BR>"
          + "perencejo " + "<a href=\"mailto:ffff@gmail.com\"> perencejo  </a> " + "<BR>"
          + "perencejo " + "<a href=\"mailto:ffff@gmail.com\"> perencejo  </a> " + "<BR>" + "<BR>");
