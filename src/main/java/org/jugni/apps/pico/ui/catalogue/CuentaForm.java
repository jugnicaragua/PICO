...
public class CuentaForm extends BaseInternalView {
  ...
  private void initCuentaForm() {
    ...
    lblNaturaleza.setToolTipText("Selecione la naturaleza de la cuenta");
    cmbNaturaleza.setBackground(bgCampoObligatorio);
    ...
    pnlCentral.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "General",
  ...
  private void agregarcomponenteAlGrid(Component componente, int fila, int columna, int anchura,
      int altura) {
